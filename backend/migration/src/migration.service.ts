...
import { stores } from '@palatine_whiteboard_backend/migration/src/store';
...
import { Migration } from '@palatine_whiteboard_backend/migration/src/command/repository/migration.repository';
